...
grouped_df = df.groupby(['Context', 'economic_gender'])[['Neg_Regard', 'Toxicity']].mean().reset_index()
...
axes[0].set_title('Toxicity Scores by Economic Status and Gender across Contexts', fontsize=14)
axes[0].set_ylabel('Toxicity Score', fontsize=12)
axes[0].set_xlabel('Economic Status and Gender', fontsize=12)
...
axes[1].set_title('Neg_Regard Scores by Economic Status and Gender across Contexts', fontsize=14)
axes[1].set_ylabel('Neg_Regard Score', fontsize=12)
axes[1].set_xlabel('Economic Status and Gender', fontsize=12)
